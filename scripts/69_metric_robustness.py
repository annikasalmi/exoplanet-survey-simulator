"""
69_metric_robustness.py — FIXES for two referee objections to scripts 56-58.
...
Run from repo root:
    python scripts/69_metric_robustness.py
"""
...
OUT_DIR = ROOT / "my_outputs" / "69_metric_robustness"
