"""
49_two_universe_rocky_puffy_overlap.py — can a PUFFY-ONLY universe be told apart
from a ROCKY+PUFFY one after the transit+RV pipelines?

Two universes (per the silicate boundary Hongyi-silicon.ddat; above = puffy, on/below = rocky):
...
Run:
    python scripts/49_two_universe_rocky_puffy_overlap.py
"""
...
OUT_DIR = os.path.join(ROOT, "my_outputs", "49_two_universe_rocky_puffy_overlap")
