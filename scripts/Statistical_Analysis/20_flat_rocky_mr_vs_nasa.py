"""
20_flat_rocky_mr_vs_nasa.py — which published ROCKY mass-radius relation, imposed on the
...
Run:
    python scripts/Statistical_Analysis/20_flat_rocky_mr_vs_nasa.py
"""
...
S72 = _load("s72", str(ROOT / "scripts" / "Statistical_Analysis" / "17_puffy_cuts_flat.py"))
S72.N_REPEATS = 4000

OUT_DIR = os.path.join(ROOT, "my_outputs", "20_flat_rocky_mr_vs_nasa")
