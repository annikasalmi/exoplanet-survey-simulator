"""
66_occurrence_correction_mdwarf.py — the completeness-corrected occurrence of cold rocky
...
Run:
    python scripts/66_occurrence_correction_mdwarf.py
"""
...
OUT_DIR = os.path.join(ROOT, "my_outputs", "66_occurrence_correction_mdwarf")
