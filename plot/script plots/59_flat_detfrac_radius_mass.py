"""
59_flat_detfrac_radius_mass.py — the plot that makes the detector physics
...
Run:
    python scripts/59_flat_detfrac_radius_mass.py
"""
...
OUT_DIR = os.path.join(ROOT, "my_outputs", "59_flat_detfrac_radius_mass")
