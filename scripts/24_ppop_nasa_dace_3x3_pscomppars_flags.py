"""
24_ppop_nasa_dace_3x3_pscomppars_flags.py
...
OUT_DIR = ROOT / "my_outputs" / "24_ppop_nasa_dace_3x3_pscomppars_flags"
...
PPOP_FALLBACK_PATHS = [
    ROOT / "my_outputs" / "19_w3_nasa_vs_ppop_notebook_style" / "plot_data_ppop_detected.csv",
    ROOT / "my_outputs" / "21_ppop_nasa_dace_insolation_3x3" / "plot_data_ppop_detected.csv",
    ROOT / "my_outputs" / "w2_nasa_real_vs_ppop_insolation" / "plot_data_ppop_detected.csv",
    ROOT / "my_outputs" / "w2_nasa_pscomppars_vs_ppop_insolation" / "plot_data_ppop_detected.csv",
]
