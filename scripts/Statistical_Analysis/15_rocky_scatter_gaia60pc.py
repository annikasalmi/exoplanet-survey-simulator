...
Run from repo root:
    python scripts/15_rocky_scatter_gaia60pc.py
"""
...
OUT_DIR = ROOT / "my_outputs" / "15_rocky_scatter_gaia60pc"
...
def main():
    print("=" * 70)
    print("15_rocky_scatter_gaia60pc.py")
    print("=" * 70)
