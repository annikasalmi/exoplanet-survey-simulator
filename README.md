...
| TESS | >=3 transits, limb-darkened TESS-band transit shape, sector windows, CDPP/SNR at T14 and 7.1 S/N | Fixed sectors and smooth Tmag noise fallback for flat simulations; SPOC TCE MES and per-TIC per-sector CDPP only in calibration/recovery figures | FFI searches, DV vetting, QLP detections, injection recovery and full contamination modeling |
