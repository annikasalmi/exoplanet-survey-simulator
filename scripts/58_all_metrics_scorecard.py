"""
58_all_metrics_scorecard.py — run ALL the population-comparison metrics (not just the
...
Run:
    python scripts/58_all_metrics_scorecard.py
"""
...
OUT_DIR = os.path.join(ROOT, "my_outputs", "58_all_metrics_scorecard")
