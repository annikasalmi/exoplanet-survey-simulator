"""
42_bayesian_cold_rocky_desert_tess.py — TESS counterpart of bayesian_cold_rocky_desert.py.
...
mission differs. Outputs land in output/plots/42_bayesian_cold_rocky_desert_tess/ so the
