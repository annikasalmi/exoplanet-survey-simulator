"""
46_tess_ppop_detector_check.py
...
Output: my_outputs/46_tess_ppop_detector_check/

Run from repo root:
    python scripts/46_tess_ppop_detector_check.py
"""
...
OUT_DIR = ROOT / "my_outputs" / "46_tess_ppop_detector_check"
