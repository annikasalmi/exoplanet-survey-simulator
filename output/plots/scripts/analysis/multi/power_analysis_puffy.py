"""
power_analysis_puffy.py — Method 1: analytic two-proportion power on the puffy fraction.
...
Outputs (output/plots/power_analysis_puffy/):
...
OUT_DIR = os.path.join(ANALYSIS_DIR, "power_analysis_puffy")
