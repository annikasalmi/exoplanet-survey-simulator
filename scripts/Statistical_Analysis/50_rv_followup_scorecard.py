...
Outputs (my_outputs/50_rv_followup_scorecard/):
...
CANDIDATE_VALUE_CSV = ROOT / "my_outputs" / "49_targeted_precision_power" / "candidate_value.csv"
OUT_DIR = ROOT / "my_outputs" / "50_rv_followup_scorecard"
