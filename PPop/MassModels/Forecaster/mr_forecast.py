...
## read parameter file
hyper_file = os.path.join(PPOP_DIR,'MassModels','Forecaster','fitting_parameters.h5')
h5 = h5py.File(hyper_file, 'r')
all_hyper = h5['hyper_posterior'][:]
h5.close()

## function
from PPop.MassModels.Forecaster.func import piece_linear, ProbRGivenM, classification
