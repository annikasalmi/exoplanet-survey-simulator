...
class PlanetDistribution():
    ...
    def __init__(self,
        ...
        # def func(R, P):
        #     return self.Gamma[0] * R**(self.alpha[0]-1.) * P**(self.beta[0]-1.)
        # F0 = dblquad(func, 0.5/self.ytod, 20000./self.ytod, 0.5, 3.4)
        
        # def func(R, P):
        #     return self.Gamma[1] * R**(self.alpha[1]-1.) * P**(self.beta[1]-1.)
        # F0 = dblquad(func, 0.5/self.ytod, 20000./self.ytod, 3.4, 16.)
