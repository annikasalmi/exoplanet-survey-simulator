"""
28_w4_koi_dr25_detector_check.py
...
Outputs
-------
ROOT / "my_outputs" / "28_w4_koi_dr25_detector_check"
...
----------
From repo root:
    python scripts/28_w4_koi_dr25_detector_check.py

Useful options:
    python scripts/28_w4_koi_dr25_detector_check.py --redownload
    python scripts/28_w4_koi_dr25_detector_check.py --no-dr25-only
    python scripts/28_w4_koi_dr25_detector_check.py --transit-mode inclination
    python scripts/28_w4_koi_dr25_detector_check.py --no-use-observed-depth
...
OUT_DIR = ROOT / "my_outputs" / "28_w4_koi_dr25_detector_check"
...
def write_data_dictionary() -> None:
    text = f"""
Figure/data dictionary for 28_w4_koi_dr25_detector_check
========================================================
