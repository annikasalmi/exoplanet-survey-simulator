...
(bayesian_cold_rocky_desert.py) and its occurrence-corrected companion
...
10M model pools are reused from output/plots/41.../ by hardlink, so nothing is regenerated.
...
Outputs -> output/plots/49_bayesian_relaxed/ (model_stats.csv + figures), copied to
...
def main():
    ...
    s41 = _load("s41_relaxed", HERE / "bayesian_cold_rocky_desert.py")
