...
Run from repo root:
    python scripts/50_rv_mr_detection.py
    python scripts/50_rv_mr_detection.py --instrument best --n-catalogs 100
    python scripts/50_rv_mr_detection.py --instrument NIRPS --mag-target 11
"""
...
OUT_DIR = ROOT / "my_outputs" / "50_rv_mr_detection"
