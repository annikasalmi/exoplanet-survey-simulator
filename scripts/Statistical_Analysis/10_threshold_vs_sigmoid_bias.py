"""
10_threshold_vs_sigmoid_bias.py
...
Outputs (in my_outputs/10_threshold_vs_sigmoid_bias/):
...
Usage:
    python scripts/10_threshold_vs_sigmoid_bias.py
    python scripts/10_threshold_vs_sigmoid_bias.py \\
...
OUT_DIR = ROOT / "my_outputs" / "10_threshold_vs_sigmoid_bias"
