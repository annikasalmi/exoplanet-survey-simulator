"""
39_likelihood_ratio_catalog.py — TEST LR (plan 5): full-catalog likelihood ratio
...
Run:
    python scripts/39_likelihood_ratio_catalog.py
"""
...
OUT_DIR = os.path.join(ROOT, "my_outputs", "39_likelihood_ratio_catalog")
