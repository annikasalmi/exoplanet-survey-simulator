"""
39_survival_analysis_radius_upper_bound.py
...
Usage:
    python scripts/39_survival_analysis_radius_upper_bound.py
    python scripts/39_survival_analysis_radius_upper_bound.py --rocky-mode mass-confirmed
    python scripts/39_survival_analysis_radius_upper_bound.py --rocky-mode radius-gap
    python scripts/39_survival_analysis_radius_upper_bound.py --rocky-mode mass-confirmed --star-types M
    python scripts/39_survival_analysis_radius_upper_bound.py --n-catalogs 400
"""
...
OUT_DIR = ROOT / "my_outputs" / "39_tess_survival_analysis_all"
