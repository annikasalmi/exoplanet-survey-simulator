"""
30_occurrence_correction.py — is the cold "red window" (low insolation, large
...
Run:
    python scripts/30_occurrence_correction.py
"""
...
OUT_DIR = os.path.join(ROOT, "my_outputs", "30_occurrence_correction")
