...
Usage:
    python scripts/42_survival_cold30.py
    python scripts/42_survival_cold30.py --rocky-mode radius-gap
    python scripts/42_survival_cold30.py --rocky-mode mass-confirmed
    python scripts/42_survival_cold30.py --rocky-mode radius-gap --star-types M
"""
...
OUT_DIR = ROOT / "my_outputs" / "42_tess_survival_cold"
