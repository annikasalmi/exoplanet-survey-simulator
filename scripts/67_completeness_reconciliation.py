"""
67_completeness_reconciliation.py — FIX for "your own two analyses disagree".
...
Run from repo root:
    python scripts/67_completeness_reconciliation.py
"""
...
OUT_DIR = ROOT / "my_outputs" / "67_completeness_reconciliation"
...
def main():
    ...
    print("=" * 70)
    print("67_completeness_reconciliation.py")
    print("=" * 70)
