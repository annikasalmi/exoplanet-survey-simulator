"""
57_universe_metrics_vs_nasa.py — "which fake universe is closest to the OBSERVED one?"
...
Run:
    python scripts/57_universe_metrics_vs_nasa.py
"""
...
OUT_DIR = os.path.join(ROOT, "my_outputs", "57_universe_metrics_vs_nasa")
