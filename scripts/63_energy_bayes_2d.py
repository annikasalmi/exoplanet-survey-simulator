"""
63_energy_bayes_2d.py — the two PROPER whole-distribution model comparisons in the 2-D
...
Run:
    python scripts/63_energy_bayes_2d.py
"""
...
OUT_DIR = os.path.join(ROOT, "my_outputs", "63_energy_bayes_2d")
