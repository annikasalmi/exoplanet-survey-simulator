"""
24_metrics_distributions.py — the bell-curve (sampling-distribution) view of ALL the
...
Run:
    python scripts/24_metrics_distributions.py
"""
...
OUT_DIR = os.path.join(ROOT, "output/plots", "24_metrics_distributions")
