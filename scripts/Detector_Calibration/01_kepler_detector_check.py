...
Output: my_outputs/01_kepler_detector_check/

Run from repo root:
    python scripts/01_kepler_detector_check.py
"""
...
OUT_DIR = ROOT / "my_outputs" / "01_kepler_detector_check"
