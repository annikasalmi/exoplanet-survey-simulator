...
KEPLER_PPOP_DIR = Path(KEPLER_DATA_DIR) / "Gaia_C_F_K_combined"
TESS_PPOP_DIR   = Path(TESS_DATA_DIR) / "Gaia_C_F_K_combined_cdpp_v1"
...
OUT_DIR = Path(ANALYSIS_DIR) / "55_kepler_tess_rocky_fgkm_detection"
