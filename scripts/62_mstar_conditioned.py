"""
62_mstar_conditioned.py — condition the rocky/puffy comparison on HOST-STAR TYPE.
...
Run:
    python scripts/62_mstar_conditioned.py
"""
...
OUT_DIR = os.path.join(ROOT, "my_outputs", "62_mstar_conditioned")
