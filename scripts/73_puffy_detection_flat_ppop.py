"""
73_puffy_detection_flat_ppop.py — how each telescope (transit / RV / transit+RV) shifts the
...
Run:
    python scripts/73_puffy_detection_flat_ppop.py
"""
...
OUT_DIR = os.path.join(ROOT, "my_outputs", "73_puffy_detection_flat_ppop")
