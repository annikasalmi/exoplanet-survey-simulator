"""
40_kepler_survival_analysis.py
...
WHAT IS DIFFERENT FROM SCRIPT 39:
  ...
  - Output dir      : my_outputs/40_kepler_survival_analysis/
...
Usage:
    python scripts/40_kepler_survival_analysis.py
    python scripts/40_kepler_survival_analysis.py --rocky-mode radius-gap
    python scripts/40_kepler_survival_analysis.py --rocky-mode mass-confirmed --star-types F,G,K,M
"""
...
OUT_DIR = ROOT / "my_outputs" / "40_kepler_survival_analysis"
