...
Run from repo root:
    python scripts/58_rv_rocky_fgkm_test.py
    python scripts/58_rv_rocky_fgkm_test.py --instrument HARPS --n-catalogs 200
"""
...
def main():
    ...
    print("=" * 70)
    print("58_rv_rocky_fgkm_test.py — RV-test companion to script 44")
    print("=" * 70)
