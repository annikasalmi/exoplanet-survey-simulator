...
Run from repo root:
    python scripts/64_cold_window_power_test.py
    python scripts/64_cold_window_power_test.py --transit geometric --rv-only
"""
...
S53 = _load_module("s53", ROOT / "scripts" / "53_rv_2x4_rocky_fgkm_rvtest.py")

OUT_DIR = ROOT / "my_outputs" / "64_cold_window_power_test"
...
def main():
    ...
    print("=" * 70)
    print("64_cold_window_power_test.py")
    print("=" * 70)
