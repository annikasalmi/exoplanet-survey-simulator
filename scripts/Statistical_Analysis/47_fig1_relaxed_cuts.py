...
15_rocky_scatter_gaia60pc.py; only the three thresholds and the corner marker differ.
Writes to my_outputs/47_fig1_relaxed_cuts/ only, never to paper/figures/.
"""
...
_spec = importlib.util.spec_from_file_location(
    "rocky_scatter_gaia60pc", HERE / "15_rocky_scatter_gaia60pc.py")
...
OUT_DIR = ROOT / "my_outputs" / "47_fig1_relaxed_cuts"
