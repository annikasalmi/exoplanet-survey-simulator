...
OUT_DIR = ROOT / "my_outputs" / "48_relaxed_redo"
...
def census():
    s15 = _load("s15_census", HERE / "15_rocky_scatter_gaia60pc.py")
    ...
    s47.main()
    src = ROOT / "my_outputs" / "47_fig1_relaxed_cuts" / "rocky_mr_insolation_3panel_r135_prec10_30.png"
    shutil.copy(src, FIGS_V2 / "rocky_mr_insolation_3panel_v2.png")
    print(f"\nCopied fig 1 v2 -> {FIGS_V2 / 'rocky_mr_insolation_3panel_v2.png'}")


def fvol():
    S72 = _load("s72_v2", HERE / "17_puffy_cuts_flat.py")
    ...
    s20 = _load("s20_v2", HERE / "20_flat_rocky_mr_vs_nasa.py")
...
def nasabells():
    S72 = _load("s72_nb", HERE / "17_puffy_cuts_flat.py")
    S72.NASA_MASS_PREC = NEW_MASS_PREC
    S72.NASA_RAD_PREC = NEW_RAD_PREC
    S72.N_REPEATS = N_REPEATS
...
def maps(mission="TESS"):
    s21 = _load("s21_v2", HERE / "21_flat_transit_rv_3x3.py")
...
def pvol(s_max=COLD_INSOL):
    S72 = _load("s72_pvol", HERE / "17_puffy_cuts_flat.py")
    S72.NASA_MASS_PREC = NEW_MASS_PREC
    S72.NASA_RAD_PREC = NEW_RAD_PREC
    S72.N_REPEATS = N_REPEATS
    m_sil, r_sil = S72.load_silicate()
...
def specs():
    ...
    s15 = _load("s15_specs", HERE / "15_rocky_scatter_gaia60pc.py")
    m_ref, r_ref = s15.load_rocky_reference_curve()
    shift = s15.compute_rocky_threshold_shift(m_ref, r_ref)
    ...
    S72 = _load("s72_specs", HERE / "17_puffy_cuts_flat.py")
...
def xcold(s_max=10.0):
    s15 = _load("s15_xcold", HERE / "15_rocky_scatter_gaia60pc.py")
    m_ref, r_ref = s15.load_rocky_reference_curve()
    shift = s15.compute_rocky_threshold_shift(m_ref, r_ref)
    ...
    S72 = _load("s72_xc", HERE / "17_puffy_cuts_flat.py")
    S72.NASA_MASS_PREC = NEW_MASS_PREC
    S72.NASA_RAD_PREC = NEW_RAD_PREC
    S72.N_REPEATS = N_REPEATS
    m_sil, r_sil = S72.load_silicate()
    ...
    s20 = _load("s20_xc", HERE / "20_flat_rocky_mr_vs_nasa.py")
...
def design(n_draw=2_000_000):
    ...
    s15 = _load("s15_design", HERE / "15_rocky_scatter_gaia60pc.py")
    m_ref, r_ref = s15.load_rocky_reference_curve()
