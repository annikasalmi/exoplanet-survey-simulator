...
Run from repo root:
    python scripts/06_rv_detector_check.py
    python scripts/06_rv_detector_check.py --instrument NIRPS --n-catalogs 80
"""
...
OUT_DIR = ROOT / "my_outputs" / "06_rv_detector_check"
