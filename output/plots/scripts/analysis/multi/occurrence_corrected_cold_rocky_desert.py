...
bayesian_cold_rocky_desert.py, in the SAME (M,R) 3x3 universe x insolation format.
...
C_FLOOR = 0.02   # completeness below this -> correction amplifies noise unboundedly => UNCONSTRAINED
                 # (mirrors ETA_MIN in scripts/statistical_analysis/occurrence_correction.py)
