...
Usage:
    python scripts/41_kepler_tess_combined.py
    python scripts/41_kepler_tess_combined.py --rocky-mode radius-gap
    python scripts/41_kepler_tess_combined.py --rocky-mode mass-confirmed --star-types F,G,K,M
"""
...
OUT_DIR = ROOT / "my_outputs" / "41_kepler_tess_combined"
