"""
55_kepler_tess_rocky_fgkm_detection.py
...
Run from repo root:
    python scripts/55_kepler_tess_rocky_fgkm_detection.py
"""
...
OUT_DIR = ROOT / "output/plots" / "55_kepler_tess_rocky_fgkm_detection"
...
def main():
    print("=" * 70)
    print("55_kepler_tess_rocky_fgkm_detection.py")
    print("=" * 70)
