...
bus_read.build_from_config(os.path.join(DEMO_DIR, 'test_runs_0.yaml'))
bus_read.data.import_catalog(input_path=os.path.join(DEMO_DIR, 'test_runs_0_catalog.hdf5'))
