"""
16_two_universe_puffy_overlap.py — can a PUFFY-ONLY universe be told apart
...
Run:
    python scripts/16_two_universe_puffy_overlap.py
"""
...
OUT_DIR = os.path.join(ROOT, "my_outputs", "16_two_universe_puffy_overlap")
