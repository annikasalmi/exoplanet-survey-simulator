"""
21_flat_transit_rv_3x3.py — the paper's selection-operator map (Figure 2).
...
Hongyi-silicon.ddat). The flat universe draws radius/orbit/star flat, and masses
...
Run:
    python scripts/Statistical_Analysis/21_flat_transit_rv_3x3.py
"""
...
S44 = _load("s44", ROOT / "scripts" / "Statistical_Analysis" / "15_rocky_scatter_gaia60pc.py")

OUT_DIR = ROOT / "my_outputs" / "21_flat_transit_rv_3x3"
